...
/** This is a filter IceModel that wraps another existing ice model.
Produces a Surface T field for ice models that need it, from
GCM-supplied Mass and Energy fields */

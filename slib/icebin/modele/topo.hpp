...
No EXPLICIT merging is done here; the assumption is that pre-merged
EOvAO matrices alre already provided.  These utilities are used by
command-line programs, as well as GCMRegridder_ModeleE
*/
